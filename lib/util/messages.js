...
module.exports = function(projectName,messageFramework,messageTemplate) {
  return {
    helloYeti: [
      'Thanks for using Miracle stack for %s!',
      '-------------------------------------------',
    ...
    gitCloneError: "There was an issue running " + "git clone ".cyan + "to download the framework " + "Miracle ".cyan + messageFramework.cyan + " and template " + messageTemplate.cyan +".\nMake sure your computer's Git is configured properly and then try again.",
    ...
    installSuccessFinal: "\nNow run " + "miracle watch ".cyan + "while inside the " + projectName.cyan + " folder.\n",
    installFailFinal: "\nOnce you've resolved the above issues, run " + "miracle watch ".cyan + "while inside the " + projectName.cyan + " folder.\n"
  }
}
